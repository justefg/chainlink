...
func (_m *EvmTxStore) UpdateTxConfirmed(ctx context.Context, etxID []int64) error {
	ret := _m.Called(ctx, etxID)
...
//   - ctx context.Context
//   - etxID []int64
func (_e *EvmTxStore_Expecter) UpdateTxConfirmed(ctx interface{}, etxID interface{}) *EvmTxStore_UpdateTxConfirmed_Call {
	return &EvmTxStore_UpdateTxConfirmed_Call{Call: _e.mock.On("UpdateTxConfirmed", ctx, etxID)}
}

func (_c *EvmTxStore_UpdateTxConfirmed_Call) Run(run func(ctx context.Context, etxID []int64)) *EvmTxStore_UpdateTxConfirmed_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]int64))
	})
	return _c
...
func (_m *EvmTxStore) UpdateTxTerminallyStuck(ctx context.Context, etxID []int64, errMsg string) error {
...
// EvmTxStore_UpdateTxTerminallyStuck_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateTxTerminallyStuck'
type EvmTxStore_UpdateTxTerminallyStuck_Call struct {
	*mock.Call
}
...
//   - etxID []int64
//   - errMsg string
func (_e *EvmTxStore_Expecter) UpdateTxTerminallyStuck(ctx interface{}, etxID interface{}, errMsg interface{}) *EvmTxStore_UpdateTxTerminallyStuck_Call {
	return &EvmTxStore_UpdateTxTerminallyStuck_Call{Call: _e.mock.On("UpdateTxTerminallyStuck", ctx, etxID, errMsg)}
}

func (_c *EvmTxStore_UpdateTxTerminallyStuck_Call) Run(run func(ctx context.Context, etxID []int64, errMsg string)) *EvmTxStore_UpdateTxTerminallyStuck_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *EvmTxStore_UpdateTxTerminallyStuck_Call) Return(_a0 error) *EvmTxStore_UpdateTxTerminallyStuck_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *EvmTxStore_UpdateTxTerminallyStuck_Call) RunAndReturn(run func(context.Context, []int64, string) error) *EvmTxStore_UpdateTxTerminallyStuck_Call {
	_c.Call.Return(run)
	return _c
}
