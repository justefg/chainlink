...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.2.2-0.20240821181808-638ab1d9f4e0
...
require (
	...
	github.com/smartcontractkit/chainlink-cosmos v0.4.1-0.20240821191029-d5b91de1201c // indirect
